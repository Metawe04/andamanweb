...
module.exports = {
  ...
  entry: {
    ...
    "bundle.min.js": [
      path.resolve(__dirname, "frontend/web/app/app.js"),
      path.resolve(__dirname, "common/themes/mamba/assets/dist/vendor/jquery.easing/jquery.easing.min.js"),
      path.resolve(__dirname, "common/themes/mamba/assets/dist/vendor/php-email-form/validate.js"),
      path.resolve(__dirname, "common/themes/mamba/assets/dist/vendor/jquery-sticky/jquery.sticky.js"),
      path.resolve(__dirname, "common/themes/mamba/assets/dist/vendor/venobox/venobox.min.js"),
      path.resolve(__dirname, "common/themes/mamba/assets/dist/vendor/waypoints/jquery.waypoints.min.js"),
      path.resolve(__dirname, "common/themes/mamba/assets/dist/vendor/counterup/counterup.min.js"),
      path.resolve(__dirname, "common/themes/mamba/assets/dist/vendor/fancybox/jquery.fancybox.min.js"),
      path.resolve(__dirname, "common/themes/mamba/assets/dist/js/main.js"),
      // path.resolve(__dirname, "frontend/web/js/smoothscroll.js"),
      // path.resolve(__dirname, "frontend/web/js/jssocials/jssocials.min.js"),
    ],
  },
  output: {
    filename: "[name]",
