...
-- ----------------------------
INSERT INTO `tb_department` VALUES (1, 'เกษตรกลวิธาน', 1);
...
-- ----------------------------
INSERT INTO `tb_faculty` VALUES (1, 'คณะเกษตรศาสตร์', 0);
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'admin', 'admin-ku@gmail.com', '$2y$12$P/nrEYjCwBNEyQHt//O2VOJw/WjSjCoV32HuOXxthIDKmpP9LCalK', '7sCGkzBxTGIyoig1cxWzjlziAhH5nnDj', 1591830631, NULL, NULL, NULL, 1591830630, 1591830630, 0, 1607308345);
...
-- ----------------------------
INSERT INTO `widget_carousel_item` VALUES (4, 1, 'http://faculty-ku.local/storage/source', '\\1\\_smRUcrjsmJYAm-Ry-BkRGt-gMWcsj07.png', 'http://faculty-ku.local/storage/source/\\1\\_smRUcrjsmJYAm-Ry-BkRGt-gMWcsj07.png', 'image/png', '', '<h2>Department of Farm Mechanics</h2><h2>Faculty of Agriculture</h2><h2>Kasetsart University</h2>', 1, 1, 1592020216, 1605089166);
INSERT INTO `widget_carousel_item` VALUES (5, 1, 'http://faculty-ku.local/storage/source', '\\1\\0xFUZAZkaObPeBCWwkOORhy-rwPectXZ.png', 'http://faculty-ku.local/storage/source/\\1\\0xFUZAZkaObPeBCWwkOORhy-rwPectXZ.png', 'image/png', 'http://faculty-ku.local/', '<h2>หลักสูตร วท.บ-เทคโนโลยีระบบเกษตร</h2><p>Bimply dummy text of the printing and typesetting istryrem Ipsum has been the industry\'s standard dummy text ever when an unknown printer.</p>', 1, 3, 1592020242, 1605089194);
INSERT INTO `widget_carousel_item` VALUES (6, 1, 'http://faculty-ku.local/storage/source', '\\1\\vt97Pj2k4mdLaDfTkji6sExWTT36Xgy1.png', 'http://faculty-ku.local/storage/source/\\1\\vt97Pj2k4mdLaDfTkji6sExWTT36Xgy1.png', 'image/png', '', '<h2>หลักสูตร วท.ม-เทคโนโลยีระบบเกษตร</h2>', 1, 2, 1592020264, 1605089183);
