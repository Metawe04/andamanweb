...
class PdfJs extends \yii\base\Widget
{
  ...
  public function init()
  {
    ...
    $this->getView()->registerJsFile(Yii::$app->assetManager->getPublishedUrl('@yii2assets/pdfjs/assets') . '/yii2-pdfjs.js', ['depends' => [\mamba\assets\MambaAsset::className()]]);
  }
  ...
  public function run()
  {
    ...
    return $this->render('@yii2assets/pdfjs/views/viewer', [
