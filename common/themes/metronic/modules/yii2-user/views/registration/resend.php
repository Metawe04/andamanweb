        ...
        <div class="login-form p-7 position-relative overflow-hidden">
            ...
            <div class="login-forgot">
                ...
                <div class="form-group d-flex flex-wrap flex-center mt-10">
                    <?= Html::submitButton(Yii::t('user', 'Continue'), ['class' => 'btn btn-primary font-weight-bold px-9 py-4 my-3 mx-2']) ?>
                    <?= Html::a('ยกเลิก', ['/auth/login'], ['class' => 'btn btn-light-primary font-weight-bold px-9 py-4 my-3 mx-2']) ?>
                </div>
                <?php ActiveForm::end(); ?>
            </div>
