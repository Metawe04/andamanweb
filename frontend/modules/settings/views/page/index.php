...
/* @var $searchModel frontend\modules\settings\models\search\PageSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'ตั้งค่าเพจ';
                ...
                [
                    ...
                    'buttons' => [
                        'view' => function ($url, $model, $key) {
                            return Html::a('<i class="flaticon-browser"></i>', Yii::$app->params['baseUrl'].'/frontend/web/index.php?r=page%2Fview&slug='.$model['slug'], [
