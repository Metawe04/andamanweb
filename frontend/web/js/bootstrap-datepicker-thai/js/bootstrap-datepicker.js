...
(function($) {
  ...
  var Datepicker = function(element, options) {
    ...
    if (this.o.rtl) {
      ...
      this.picker.find(".prev i, .next i").toggleClass("flaticon2-left-arrow flaticon2-right-arrow");
    }
  ...
  var DPGlobal = {
    ...
    headTemplate:
      "<thead>" +
      "<tr>" +
      '<th class="prev"><i class="flaticon2-left-arrow"/></th>' +
      '<th colspan="5" class="datepicker-switch"></th>' +
      '<th class="next"><i class="flaticon2-right-arrow"/></th>' +
      "</tr>" +
      "</thead>",
