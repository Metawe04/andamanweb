...
/* @var $searchModel common\models\search\TbResearchSearch */
...
<div class="card card-custom">
    ...
    <div class="card-body">
        ...
        'columns' => [
            ...
            [
                'attribute' => 'research_type_id',
                'headerOptions' => [
                    'style' => 'text-align:center;'
                ],
                'value' => function($model) {
                    return @$model->researchType->research_type_name; 
                },
                'format' => 'raw',
            ],
            [
                'attribute' => 'research_type_work_id',
                'format' => 'html',
                'headerOptions' => [
                    'style' => 'text-align:center;'
                ],
                'value' => function($model) {
                    return @$model->researchTypeWork->research_type_work_name; 
                },
                'format' => 'raw',
            ],
            [
                'attribute' => 'research_user',
                'header' => 'ผู้รับผิดชอบ',
                'format' => 'html',
                'headerOptions' => [
                    'style' => 'text-align:center;'
                ...
                'value' => function($model) {
                    return $model->researchUserName; 
                },
                'format' => 'raw',
           
            ],
            [
                'attribute' => 'research_status',
